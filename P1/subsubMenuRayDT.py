...
def subsubMenuRyDT():
    ventana = tk.Tk()
    ventana.title("Análisis de tipos de Desvanecimiento: NLOS") #nombre de la ventana
    ...
    def boton1_click():
        ...
        Tau_B2, PDPdB2, Tc, t_axis, h_t = fadingRayleigh.simular_fading_T(params)

        # 2. Mostrar resultados en otra interfaz
        GraficaRyDT.mostrar_graficas(Tau_B2, PDPdB2, Tc, t_axis, h_t, params)
